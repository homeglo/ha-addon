...
if ($home_record = Yii::$app->session->get('home_record')) { //we are inside a home
            ...
            [
                ...
                [
                    ...
                    'items' => [
                        [
                            'label' => 'Sensors',
                            'url' => ['/sensors'], //  Array format of Url to, will be not used if have an items
                        ],
                        [
                            'label' => 'Lights',
                            'icon' => 'fa fa-lightbulb',
                            'url' => ['/lights'], //  Array format of Url to, will be not used if have an items
                        ],
                        [
                            'label' => 'Groups',
                            'url' => ['/groups'], //  Array format of Url to, will be not used if have an items
                        ],
                        [
                            'label' => 'Scenes',
                            'url' => ['/scenes'], //  Array format of Url to, will be not used if have an items
                        ],
                    ]
                ],
            ]);
    ...
    $sideBarItems = [
        [
            'label' => 'Homes',
            'url' => ['/hg-home'], //  Array format of Url to, will be not used if have an items
